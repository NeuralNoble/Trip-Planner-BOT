...
class TravelTasks:
    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output="""Provide a detailed 7-day itinerary including:
                - Daily activities and timing
                - Specific restaurants and booking recommendations
                - Hotel details and locations
                - Weather forecasts
                - Budget breakdown
                - Packing suggestions
                The output should be well-structured and ready to follow."""
        )
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        ...
        """
            ...
            agent=agent,
            expected_output="""Provide a comprehensive city selection report including:
                - Selected city with justification
                - Flight costs and options
                - Weather analysis
                - Key attractions matching interests
                - Overall cost comparison
                The report should clearly explain why this city is the best choice."""
        )
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output="""Deliver a comprehensive city guide including:
                - Key attractions and landmarks
                - Local customs and cultural information
                - Special events during travel dates
                - Weather patterns and forecasts
                - Cost estimates for activities
                - Hidden gems and local recommendations
                The guide should be detailed and actionable."""
        )